...
import com.deck.engine.CardComparator;
...
public class Card {
  ...
  public void insertionSort(Card[] cardsToSort) {
	    final Comparator cardComparator = new CardComparator();
	    for (int i = 0; i < cardsToSort.length - 1; i++) {
	        for (int k = i + 1; k > 0; k--) {
	            final Card card1 = cardsToSort[k];
	            final Card card2 = cardsToSort[k - 1];
